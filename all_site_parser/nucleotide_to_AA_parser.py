...
# Load reference
ref = SeqIO.read(cwd / 'NC_045512.2.fasta', format='fasta')

# Load genome annotations
meta = pd.read_csv(cwd / 'wuhan-hu-1_genome_annotations.csv')
...
# Save
final_df.to_csv(cwd / 'SARS-CoV-2_hookup_table.csv', index=False)
